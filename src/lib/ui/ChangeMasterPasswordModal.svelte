...
>
  {#if showingRecoveryKit}
    ...
    <label class="recovery-confirm"><input type="checkbox" bind:checked={recoveryConfirmed} /> <span>I saved this outside Sesame.</span></label>
  ...
  {:else}
    ...
    <form on:submit|preventDefault={onSave}>
      <label>Current master password<input type="password" bind:value={currentPassword} autocomplete="current-password" /></label>
      <label>New master password<input type="password" bind:value={newPassword} autocomplete="new-password" /></label>
      <label>Confirm new password<input type="password" bind:value={confirmPassword} autocomplete="new-password" /></label>
